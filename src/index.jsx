...
const App = (props) => {
	...
	return (
		<div className="box">
			...
			<div id="number-div">
				<label htmlFor="number">Number of Photos (1-30): </label>
				<input id="number" type="number" ref={numInput} defaultValue={numPhotos} min="1" max="30" onChange={changeNumPhotos} />
			</div>
				...
				{ query ?
					photos.map(photo => (
						<div key={photo.id} className="item">
							<img className="img" src={photo.urls.regular} alt={`${photo.description} from Unsplash, taken by ${photo.user.name}`} />
...
ReactDOM.createRoot(document.getElementById('root')).render(<App name="David" emoji="✈️"/>);
